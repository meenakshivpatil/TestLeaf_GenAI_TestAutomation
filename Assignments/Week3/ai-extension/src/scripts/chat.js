...
class ChatUI {
    ...
    initialize() {
        ...
        chrome.storage.sync.get(
          ['groqApiKey','openaiApiKey','testleafApiKey','awsBdrkApiKey','selectedModel','selectedProvider'],
          (result) => {
            ...
            if (result.awsBdrkApiKey) this.awsBdrkAPI = new AwsbdrkAPI(result.awsBdrkApiKey);
        ...
        chrome.storage.onChanged.addListener((changes) => {
            ...
            if (changes.awsBdrkApiKey)    this.awsBdrkAPI = new AwsbdrkAPI(changes.awsBdrkApiKey.newValue);
    ...
    async sendMessage() {
        ...
        else if (this.selectedProvider === 'aws-bdrk') apiRef = this.awsBdrkAPI;
        else apiRef = this.testleafAPI;
        console.log('Selected Provider:', this.selectedProvider, 'API Ref:', apiRef);
        if (!apiRef) {
